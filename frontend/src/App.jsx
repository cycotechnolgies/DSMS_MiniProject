          ...
          <ProtectedRoute user={user}>
            <RootLayout>
              <Routes>
                ...
                {/* Other Routes */}
                <Route path='/staff/enroll' element={<AddStaff />} />
                <Route path='/staff/:id' element={<AddStaff />} />
                <Route path='/staff/profile/:id' element={<StaffProfile />} />
                <Route path='/student/enroll' element={<AddStudent />} />
                <Route path='/student/:id' element={<AddStudent />} />
                <Route path='/pay/new' element={<AddPayment />} />
                <Route path='/pay/:id' element={<AddPayment />} />
                <Route path='/pay/details/:id' element={<PaaymentView />} />
                <Route path='/medi/new' element={<AddMedical />} />
                <Route path='/medi/:id' element={<AddMedical />} />
                <Route path='/renew/new' element={<AddRenewal />} />
                <Route path='/renew/:id' element={<AddRenewal />} />
                <Route path='/class/new' element={<AddClass />} />
                <Route path='/class/:id' element={<AddClass />} />
              </Routes>
            </RootLayout>
          </ProtectedRoute>
        } />
