...
if(isset($_SESSION['next']) && $_SESSION['next'] === 1){
    ...
    if ($stmt->rowCount() === 1) {
        ...
        $query = "INSERT INTO staff(userId, fullName, gen, nic, passNo, addr, tel, waNo, jobType) 
        VALUES (:userId, :fullName, :gen, :nic, :passNo, :addr, :tel, :waNo, :jobType);";
        ...
        $stmt->bindParam(':passNo', $passport);
...
<html>
  <head>
    ...
    <title>ADD NEW STAFF - RPSMS</title>
  </head>
  <body>
    <div class="drawer lg:drawer-open">
      ...
      <div class="drawer-content flex flex-col">
        ...
        <!-- navbar -->
            ...
            <h4 class=" text-xl md:text-xl lg:text-2xl font-bold "><i class="fa-solid fa-user-tie"></i> ADD NEW STAFF</h4>
            ...
            <div class="p-4">
                <form action="" method="post">
                    ...
                    <div class="cols grid md:grid-cols-2 gap-4 w-full">
                        <div>
                        ...
                        <div>
                            <label for="typeSelect">Job position / රැකියාවේ තනතුර<span class="text-red-500">*</span></label><br>
                            <select class="w-full my-2 p-2 rounded-md border border-gray-400" required name="typeSelect" id="typeSelect">
