      ...
      <div class="drawer-content flex flex-col ">
        ...
        <div data-theme="none" class="p-4">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 p-4">
            ...
            <!-- <div class="mt-4">
            <div class="max-w-md mx-auto bg-blue-200 rounded-xl shadow-md overflow-hidden md:max-w-2xl">
                <div class="flex flex-col md:flex-row">
                    <div class="md:shrink-0 p-2 flex justify-center items-center">
                    <img class="h-auto w-[100px] object-cover md:h-auto md:w-1/2" src="../../images/boc logo.png" alt="Modern building architecture">
                    </div>
                    <div class="p-8">
                    <div class="capitalize tracking-wide text-base font-bold">Beneficent Name : <span class="font-semibold capitalize">G. G. K. R. Gamage</span></div>
                    <div class="capitalize tracking-wide text-base font-bold">Account Number : <span class="font-semibold capitalize">G. G. K. R. Gamage</span></div>
                    <div class="capitalize tracking-wide text-base font-bold">Branch : <span class="font-semibold capitalize">G. G. K. R. Gamage</span></div>
