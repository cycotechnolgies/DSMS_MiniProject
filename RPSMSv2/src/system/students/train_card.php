        ...
        <div class="p-4 h-screen mt-4">
          <div class="grid grid-cols-1 md:grid-cols-2 sm:grid-cols-2 gap-4">
            ...
            <?php
              ...
              FROM cards
              INNER JOIN schedule ON cards.ClassId = schedule.schedId WHERE cards.userId = :sids;";
              $rows = $conn->prepare($query);
              $rows->bindParam(':sids', $stuid);
              $rows->execute();
                          ...
                          echo '
                              ...
                              ';
                                ...
                                <div class="my-4 mx-4">
                                  ...
                                  class="px-4 py-2 my-4 rounded-lg bg-green-600 text-white font-bold w-full inline-block text-center"
                                >
                          ...
                          echo '
                              ...
                              ';
                                ...
                                <div class="my-4 mx-4">
                                  ...
                                  <a
                                  href="../phpconfigs/cardPrint.php?cardId='.$cardId.'"
                                  class="px-4 py-2 my-4 w-full rounded-lg bg-green-600 text-white font-bold inline-block text-center"
                                >
                                <i class="fa-solid fa-download"></i> &nbsp; Download
                                </a>
                                  </div>
