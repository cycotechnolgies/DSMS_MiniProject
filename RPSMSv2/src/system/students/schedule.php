    ...
    <div class="drawer lg:drawer-open">
      ...
      <div class="drawer-content flex flex-col">
        ...
        <div data-theme="none" class="p-4">
          <h4 class=" text-xl md:text-xl lg:text-2xl font-bold "><i class="fa-regular fa-calendar-days"></i> Schedules</h4>
            ...
            <form action="" method="post">
              ...
              <div class="relative">
                ...
                <input
                  ...
                  placeholder="Search schedules info"
        ...
        <?php
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                $query = "SELECT * FROM schedule WHERE  LIKE :find OR  userId LIKE :find OR addr LIKE :find OR fullName LIKE :find OR nic LIKE :find OR tel LIKE :find OR apponite LIKE :find;";
                ...
                $query = "SELECT *, class.stuId, class.schedId FROM schedule
                LEFT JOIN class ON schedule.schedId = class.schedId WHERE class.stuId = :stuId;";
                $rows = $conn->prepare($query);
                $rows->bindParam(':stuId', $_SESSION['uid']);
                $rows->execute();
                $result = $rows->fetchAll(PDO::FETCH_ASSOC);
            ...
            if ($result > 0) {
                foreach ($result as $row) {
                    ...
                    echo '
                        <div class="bg-blue-200 space-y-3 p-4 rounded-lg shadow" >
                            <div class="flex items-center space-x-2 text-sm">
                                <div>
                                    <a href="#" class="text-blue-500 font-bold hover:underline">#' . $shedId . '</a>
                                </div>
                            ...
                            <div class="text-lg text-gray-700 uppercase font-semibold">' . $clsName .' - '.$typ. '</div>
                            <div class="text-lg text-gray-700"> Instructor: ' . $inst . '</div>
              ...
              echo 'No Classes Enrolled for You..';
            }
            ?>
