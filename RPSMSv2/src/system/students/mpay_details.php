...
FROM student
LEFT JOIN medi_payments ON student.userId = medi_payments.userId
WHERE student.userId = :userId  AND medi_payments.mpay_id = :payId
LIMIT 1;";
    ...
    <div class="drawer lg:drawer-open">
      ...
      <div class="drawer-content flex flex-col ">
        ...
        <div class="flex justify-end items-end">
                <a href="../phpconfigs/prints_medi.php?pid=<?php echo $payId;?>&uid=<?php echo $userId;?>" target="_blank">
