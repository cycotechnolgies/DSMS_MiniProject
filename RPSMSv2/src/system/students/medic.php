      ...
      <div class="drawer-content flex flex-col">
        ...
        <?php
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                $query = "SELECT *, DATE(date) AS date FROM medic WHERE userId = $userId AND medId LIKE :find OR  userId LIKE :find OR addr LIKE :find OR fullName LIKE :find OR nic LIKE :find OR tel LIKE :find OR apponite LIKE :find;";
                ...
                $query = "SELECT *, DATE(date) AS date FROM medic WHERE userId = :userId;";
                $rows = $conn->prepare($query);
