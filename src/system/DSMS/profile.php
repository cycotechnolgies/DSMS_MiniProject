      ...
      <div class="drawer-content flex flex-col">
        ...
        <div class="bg-gray-100">
            <div class="container mx-4 py-8">
                <div class="grid grid-cols-4 sm:grid-cols-12 gap-4 px-4">
                    <div class="col-span-4 sm:col-span-3">
                        <div class="bg-white shadow rounded-lg p-4">
                            ...
                            <div class="flex flex-col">
                                ...
                                <p class="ml-4"><i class="fa-solid fa-taxi"></i></p>
                                ...
                                <hr class="mb-2 border-t border-gray-300">
                                <p class="ml-4"><i class="fa-regular fa-calendar-days"></i> </p>

                                <h4 class="mt-4 text-base font-semibold uppercase">Training</h4>
                                <hr class="mb-2 border-t border-gray-300">
                                <p class="ml-4"><i class="fa-solid fa-chalkboard-user"></i></p>
                    ...
                    <div class="col-span-4 sm:col-span-9">
                        <div class="bg-white shadow rounded-lg p-2">
                            ...
                            <form action="" method="post" id="form1">
                                <div>
                                    ...
                                    <div class="cols">
                                      ...
                                      ><br>
                                      <input class="border my-2 border-gray-400 rounded-md w-full p-2 focus:border-blue-500 focus:outline-none" type="text" id="InName" name="inName" placeholder="D.M. Saman Kumara" value=""  required />
                                    </div>
                                    <div class="cols grid md:grid-cols-2 gap-4">
                                      <div>
                                        <label for="dob">Birth Day / උපන් දිනය <span class="text-red-500">*</span></label><br>
                                        <input class="border my-2 border-gray-400 rounded-md w-full p-2 focus:border-blue-500 focus:outline-none" type="date" id="dob" name="dob" maxlength="10" value=""  placeholder="2001/05/25" required />
                                      </div>
                                        <div>
                                        <label for="age">Age / වයස <span class="text-red-500">*</span></label><br>
                                        <input class="border my-2 border-gray-400 rounded-md w-full p-2 focus:border-blue-500 focus:outline-none" type="text" id="age" name="age" maxlength="2" value=""  placeholder="22" required />
                                      </div>
                                      </div>
                                    ...
                                    <div>
                                      ...
                                      <input class="border my-2 border-gray-400 rounded-md w-full p-2 focus:border-blue-500 focus:outline-none" type="text" name="nic" id="nic" maxlength="12" value=""   placeholder="96******* V / 20**********" required />
                                    </div>
                                      <div>
                                      <label for="ppn">Passport No. / විදේශ ගමන් බලපත්‍ර අංකය</label><br>
                                      <input class="border my-2 border-gray-400 rounded-md w-full p-2 focus:border-blue-500 focus:outline-none" type="text" name="ppn" id="ppn" placeholder="N17******" value=""   maxlength="10" />
                                    </div>
                                    </div>
                                    <div>
                                      <label for="addr">Permenent Address / ස්ථීර ලිපිනය<span class="text-red-500">*</span></label>
                                      <input class="border my-2 border-gray-400 rounded-md w-full p-2 focus:border-blue-500 focus:outline-none" type="text" name="addr" id="addr"value=""   placeholder="No. 152, ***********,********" required />
                                    </div>
                                    <div class="cols grid md:grid-cols-2 gap-4">
                                      <div>
                                        <label for="mobi">Mobile No. / දුරකථන අංකය<span class="text-red-500">*</span></label>
                                        <input class="border my-2 border-gray-400 rounded-md w-full p-2 focus:border-blue-500 focus:outline-none" type="text" name="tel" id="mobi" maxlength="10" value=""   placeholder="07* *******" required />
                                      </div>
                                        <div>
                                          <label for="wa">WhatsApp No. / වට්ස්ඇප් අංකය<span class="text-red-500">*</span></label>
                                          <input class="border my-2 border-gray-400 rounded-md w-full p-2 focus:border-blue-500 focus:outline-none" type="text" name="wa" id="wa"  placeholder="07* *******" value=""   maxlength="10"required />
                                      </div>
                                    </div>
                                    <div class="cols grid md:grid-cols-2 gap-4">
                                      <div>
                                      <label for="email">Email Address / ඊමේල් ලිපිනය<span class="text-red-500">*</span></label>
                                      <input class="border my-2 border-gray-400 rounded-md w-full p-2 focus:border-blue-500 focus:outline-none" type="email" name="email" id="email" value=""   placeholder="example@gmail.com" required />
                                      </div>
                                        <div>
                                          <label for="wa">Old License No. / පැරණි බලපත්‍ර අංකය<span class="text-red-500">*</span></label>
                                          <input class="border my-2 border-gray-400 rounded-md w-full p-2 focus:border-blue-500 focus:outline-none" type="text" name="wa" id="wa"  placeholder="0***********" value="" required />
                                      </div>
                                    </div>
                                  </div>
                            </form>
                            ...
                            <div class="flex flex-row gap-4">
                                ...
                                <a href="progress.php?uid="><button  class="px-4 py-2 rounded-md bg-blue-600 text-white font-semibold" id="prog"  type="button"><i class="fa-regular fa-hourglass-half"></i> Timeline</button></a>
                                </div>
                                <div class="relative overflow-hidden">
                                <a href="cls_details.php?uid="><button  class="px-4 py-2 rounded-md bg-green-600 text-white font-semibold" id="prog"  type="button"><i class="fa-solid fa-chalkboard-user"></i> Training</button></a>
                                </div>
                            </div>
                            </div>
                        </div>
