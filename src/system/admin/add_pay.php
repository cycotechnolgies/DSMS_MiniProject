                      ...
                      <div class="cols grid md:grid-cols-2 gap-4 my-4">
                        <div>
                          <label for="stu_id">Student ID / ශිෂ්‍ය අංකය<span class="text-red-500">*</span></label>
                            ...
                            if(isset($_GET['uid'])) {
                                // Output the 'uid' value in the input field
                                echo '<input class="border my-2 border-gray-400 rounded-md w-full p-2 focus:border-blue-500 focus:outline-none" type="text" id="uidInput" name="stu_id" value="' . htmlspecialchars($_GET['uid']) . '" readonly>';
                            } else {
                               echo '<input class="border my-2 border-gray-400 rounded-md w-full p-2 focus:border-blue-500 focus:outline-none" type="text" id="stu_id" name="stu_id" maxlength="12" placeholder="001" required/>';
                            }
                            ?>
                      ...
                      <div class="cols">
                        ...
                        <div class="cols grid md:grid-cols-2 gap-4 my-4">
                           ...
                           <div> 
                            ...
                            <select  class="border my-2 border-gray-400 rounded-md w-full p-2 focus:border-blue-500 focus:outline-none" name="reason" id="reason" required>
                              <option value="">-- Select Reason --</option>
                              <option value="Registration Fee">Registration Fee</option>
                              <option value="Course Full Payment">Course Full Payment</option>
                              <option value="Course Installment Payment">Course Installment Payment</option>
