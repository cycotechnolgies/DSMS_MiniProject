...
<?php
          $query = "SELECT s.*, r.oldNo AS oldNo, r.course AS course, r.branch AS branch, r.train_type AS train, r.vehiClass AS clss
          FROM student s 
                        ...
                        <div class="bg-white shadow rounded-lg p-4">
                            <div class="flex flex-col items-center">
                                ...
                                <div class="mt-6 flex flex-wrap gap-4 justify-center">
                                    ...
                                    <a href="updates.php?uid=<?php echo $userId;?>"><button  class="px-4 py-2 rounded-md bg-green-600 text-white " id="uptBtn"  type="button"><i class="fa-solid fa-angles-up"></i> Update</button></a>
                                </div>
                                    ...
                                    <div class="cols grid md:grid-cols-2 gap-4">
                                      ...
                                      <input class="border my-2 border-gray-400 rounded-md w-full p-2 focus:border-blue-500 focus:outline-none" type="email" name="email" id="email" value="<?php echo $email; ?>"   placeholder="example@gmail.com" required />
                                        ...
                                        <div>
                                          ...
                                          <input class="border my-2 border-gray-400 rounded-md w-full p-2 focus:border-blue-500 focus:outline-none" type="text" name="wa" id="wa"  placeholder="0***********" value="<?php echo $oldNo; ?>" required />
                                      </div>
                                    </div>
                                  </div>
                            </form>
