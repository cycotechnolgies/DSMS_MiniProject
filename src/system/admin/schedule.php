      ...
      <div class="drawer-content flex flex-col">
        ...
        <div class="md:grid md:grid-cols-2 md:grid-rows-1 gap-4 items-center">
          ...
          <div class="absolute right-0 pr-4">
            <button
              onclick="window.location.href='add_cls.php'" 
              type="button"
            ...
            >
            <i class="fa-regular fa-calendar-days mr-4"></i>Add Schedules
            </button>
          </div>
        </div>
        ...
        <?php
            ...
            if ($result) {
                foreach ($result as $row) {
                    ...
                    echo '
                        <div class="bg-blue-200 space-y-3 p-4 rounded-lg shadow" onclick="window.location.href=\'cls_detail.php?sid='.$shedId.'&cGFpZCBhdA\'">
