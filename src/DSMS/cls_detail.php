...
<div class="drawer lg:drawer-open">
    ...
    <div class="drawer-content flex flex-col ">
        ...
        <div class="p-4 flex justify-start gap-4">
            <p class="text-xl font-bold uppercase"><span class="text-blue-600"> </span></p>
        </div>
        <hr>
        <div class="p-4 flex justify-end gap-4">
            <a href="train_card.php?cid=" ><button class="px-4 py-2 rounded-md bg-blue-600 text-white">Cards</button></a>
            <a href="add_clsStu.php?cid=" ><button class="px-4 py-2 rounded-md bg-green-600 text-white">Add</button></a>
        ...
        <div class="relative overflow-hidden m-4">
            <div class="cols grid md:grid-cols-2 gap-4">
                <div class="cols">
                    ...
                    <input class="border my-2 border-gray-400 rounded-md w-full p-2 focus:border-blue-500 focus:outline-none" type="text" name="" id="" value="" disabled />
                </div>
                <div class="cols">
