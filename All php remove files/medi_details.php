    ...
    <div class="drawer lg:drawer-open">
      ...
      <div class="drawer-content flex flex-col ">
        ...
        <div class="p-4 flex justify-end gap-4">
          <button class="px-4 py-2 rounded-md bg-green-600 text-white" id="uptBtn" type="submit" data-medid=""><i class="fa-solid fa-angles-up"></i> Update</button>
          <button  class="px-4 py-2 rounded-md bg-red-600 text-white " id="delBtn"  type="submit" data-medid=""><i class="fa-solid fa-trash-can"></i> Delete</button>
        </div>
